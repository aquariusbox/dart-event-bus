...
Yg:[function(a,b){this.MR(a,b)},"$2","gPr",4,0,18],
...
T9:[function(a){return J.kI(a)},"$1","rm",2,0,6],
...
$isiP:true,
static:{"^":"Oj,Vp,Ej,p2,ch,QC,Px,DU,kc,Gi,Fz,cR,E0,Ke,Cg,Nr,bm,FI,Kz,ek,yf,JU",Gq:function(a){var z,y
z=Math.abs(a)
y=a<0?"-":""
if(z>=1000)return""+a
...
Ri:{
"^":"a;Gh",
Yf:function(a,b){var z=this.Gh
z=H.VM(new P.Gm(z),[H.Kp(z,0)])
return H.VM(new P.nO(new M.Lu(b),z),[H.W8(z,"qh",0)])},
rA:function(a){return this.Yf(a,null)}},
Lu:{
"^":"Tp:11;a",
$1:function(a){var z=this.a
return z==null||J.bB(a).n(0,z)}}}],["","",,Z,{
"^":"",
F0:{
"^":"a;a4>"},
cq:{
...
U.x3()
z=$.aG().rA(0)
P.zK(z,new U.em(),null,null,!1,H.W8(z,"YR",0),H.W8(z,"YR",1))
U.wA(document.querySelector("#listener-1"))
U.wA(document.querySelector("#listener-2"))
y=document.querySelector("#fire-label-a")
x=document.querySelector("#fire-label-b")
w=document.querySelector("#fire-button-a")
v=document.querySelector("#fire-button-b")
z=J.Vg(w)
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new U.Lb(y)),z.el),[H.Kp(z,0)]).DN()
z=J.Vg(v)
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new U.QA(x)),z.el),[H.Kp(z,0)]).DN()},"$0","KW",0,0,1],
x3:function(){N.Jx("").gSZ().yI(new U.w0())
N.Jx("").sOR(C.tI)},
em:{
"^":"Tp:11;",
$1:function(a){return $.qc().qB("event fired:  "+H.d(J.bB(a)))}},
Lb:{
"^":"Tp:11;a",
$1:function(a){var z,y
z=$.aG()
...
if(z.YM>=4)H.vh(z.Pq())
z.MW(new Z.cq(y))
this.b.textContent="--> fired ["+$.WL+"]"
$.WL=$.WL+1}},
w0:{
"^":"Tp:21;",
$1:function(a){P.JS(a.gFl().bu(0)+"\t"+a.iJ+"\t["+a.OR.oc+"]:\t"+H.d(a.G1))}},
tw:{
"^":"a;FL,zx,Tb",
wf:function(){if(this.Tb!=null)this.Ng("Already listening for an event.")
else{var z=$.aG().Yf(0,C.SQ)
this.Tb=P.zK(z,new U.O9(this),null,null,!1,H.W8(z,"YR",0),H.W8(z,"YR",1))
this.Ng("---")
this.Ng("Listening for Event A")
this.Ng("---")}},
f1:function(){if(this.Tb!=null)this.Ng("Already listening for an event.")
else{var z=$.aG().Yf(0,C.xd)
this.Tb=P.zK(z,new U.xf(this),null,null,!1,H.W8(z,"YR",0),H.W8(z,"YR",1))
this.Ng("---")
...
y=this.zx
y.toString
y.scrollTop=C.CD.yu(C.jn.UD(C.CD.yu(C.CD.UD(y.scrollHeight))))},
Dr:function(a){var z,y
z=this.FL
this.zx=z.querySelector("textarea")
y=J.Vg(z.querySelector(".listen-a"))
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new U.P2(this)),y.el),[H.Kp(y,0)]).DN()
y=J.Vg(z.querySelector(".listen-b"))
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new U.Rh(this)),y.el),[H.Kp(y,0)]).DN()
y=J.Vg(z.querySelector(".pause"))
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new U.Rs(this)),y.el),[H.Kp(y,0)]).DN()
y=J.Vg(z.querySelector(".resume"))
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new U.wn(this)),y.el),[H.Kp(y,0)]).DN()
z=J.Vg(z.querySelector(".cancel"))
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new U.Gt(this)),z.el),[H.Kp(z,0)]).DN()},
static:{wA:function(a){var z=new U.tw(a,null,null)
z.Dr(a)
return z}}},
P2:{
"^":"Tp:11;a",
$1:function(a){return this.a.wf()}},
Rh:{
"^":"Tp:11;b",
$1:function(a){return this.b.f1()}},
Rs:{
"^":"Tp:11;c",
$1:function(a){var z,y
z=this.c
...
O9:{
"^":"Tp:11;a",
$1:function(a){this.a.Ng(J.nJ(a))}},
xf:{
"^":"Tp:22;a",
$1:function(a){this.a.Ng(J.nJ(a))}}},1],["","",,P,{
"^":"",
...
qX:function(){if($.RL||this.eT==null){var z=this.tg
if(z==null){z=P.bK(null,null,!0,N.HV)
this.tg=z}z.toString
return H.VM(new P.Gm(z),[H.Kp(z,0)])}else return N.Jx("").qX()},
nd:function(a){var z=this.tg
...
$isqV:true,
static:{"^":"V7,tm,En,Lk,re,Fn,Eb,Jn,JY,bn,ux"}},
HV:{
"^":"a;OR<,G1,iJ,Fl<,O0,kc>,I4<,M5",
...
I.$lazy($,"eventBus","y3","aG",function(){var z=new M.Ri(null)
z.Gh=P.bK(null,null,!1,null)
return z})
I.$lazy($,"_log","YP","qc",function(){return N.Jx("event_bus_example")})
I.$lazy($,"_loggers","DY","U0",function(){return P.Fl(P.qU,N.Rw)})


init.metadata=[{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"WD",args:[P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"N5",void:true,args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},{func:"IM",args:[N.HV]},{func:"rH",args:[Z.cq]},];$=null
...
if(typeof dartMainRunner==="function"){dartMainRunner(function(b){H.Rq(U.KW(),b)},[])}else{(function(b){H.Rq(U.KW(),b)})([])}})
})()
